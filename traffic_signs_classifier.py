# -*- coding: utf-8 -*-
"""traffic_signs_classifier.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/12UuOt3e2D2JhRHW74IOjah21nutIiGz7
"""
import numpy as np
...
# img = X_train[2000]
# fig1, axs1 = plt.subplots(nrows=1, ncols=4, figsize= (15,3),  squeeze=False)
# [axi.set_axis_off() for axi in axs1.ravel()]
# axs1[0][0].imshow(img)
# axs1[0][1].imshow(grayscale(img), cmap=plt.get_cmap("gray"))
# axs1[0][2].imshow(equalize(grayscale(img)), cmap=plt.get_cmap("gray"))
